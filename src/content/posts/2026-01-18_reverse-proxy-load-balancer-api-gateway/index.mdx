...
import nginx_and_apigateway_and_reverseproxy from '../../../assets/posts/2026-01-18_reverse-proxy-load-balancer-api-gateway/nginx_and_apigateway_and_reverseproxy.png';
import nginx from '../../../assets/posts/2026-01-18_reverse-proxy-load-balancer-api-gateway/nginx.png';
import api_load from '../../../assets/posts/2026-01-18_reverse-proxy-load-balancer-api-gateway/api-load.png';
...
<Image src={nginx_and_apigateway_and_reverseproxy} alt="Common setup with API gateway, load balancer, and service instances" />
<Image src={nginx} alt="Common setup with API gateway, load balancer, and service instances" />
<Image src={api_load} alt="Common setup with API gateway, load balancer, and service instances" />
